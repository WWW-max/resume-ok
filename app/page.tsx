...
import { EditorPanel, type EditorSection } from "@/components/editor/EditorPanel";
...
export default function Home() {
  ...
  return <div className={`workspace ${previewOnly ? "preview-only" : ""}`} onKeyDown={event=>{if((event.metaKey || event.ctrlKey) && !event.altKey && event.key.toLowerCase()==="z"){event.preventDefault();if(event.shiftKey)store.redo();else store.undo();}}}>
