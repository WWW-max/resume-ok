    ...
    <div className="px-4 pb-6 space-y-3">
      <div className="flex items-center justify-between mb-1">
        ...
        <Button
          onClick={addItem}
          size="sm"
          className="h-7 text-xs bg-violet-600/20 hover:bg-violet-600/30 text-violet-400 border border-violet-600/30 hover:border-violet-500/50 rounded-lg gap-1.5 transition-all"
        >
